...
function DiscoveryForm() {
    ...
    // Define the sections that will be shown one at a time
    const formSections = [
        { id: 'intro', title: 'Introduction' },
        { id: 'demographics', title: 'About You (Demographics)' },
        { id: 'recent-overwhelm', title: 'Recent Overwhelm' },
        { id: 'struggled-starting', title: 'Struggled Starting' },
        { id: 'recent-struggle', title: 'Recent Struggle Starting' },
        { id: 'tracking', title: 'Tracking Assignments' },
    ...
    const sections = [
        ...
        {
            id: 'struggled-starting',
            title: 'Struggled Starting',
            content: (
                <section>
                    <ParagraphAnswerQuestion
        ...
        {
            id: 'recent_struggle_starting',
            title: 'Recent Struggle Starting',
            content: (
                <section>
                    <ParagraphAnswerQuestion
            ...
            content: (
                <section>
                    <ParagraphAnswerQuestion
                        ...
                        required={true}
                        placeholder="Please describe your system..."
                    />
                    <FollowUpQuestion
            ...
            content: (
                <section>
                    <ParagraphAnswerQuestion
                        ...
                        required={true}
                        placeholder="Please describe your past systems..."
                    />
                    <FollowUpQuestion
        ...
        {
            id: 'recent_difficult_day',
            title: 'Recent Difficult Day',
            content: (
                <section>
                    <ParagraphAnswerQuestion
        ...
        {
            id: 'dropping_out',
            title: 'Dropping Out, Pausing, Changing Majors?',
            content: (
                <section>
                    <ParagraphAnswerQuestion
                        name="dropping_out"
